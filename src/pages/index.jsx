  ...
  return (
    <main className="flex">
      <aside className={`bg-gradient-to-b from-[#2A58D0] via-[#5740B4] to-[#4291B4] w-[270px] fixed h-screen ${inter.className}`}>
        ...
        <ul className="relative text-[36px] flex flex-col //gap-[87px] items-center //bg-white fill-transparent">
          <div className="w-full bg-[#f5f5f5] absolute h-[25%] //translate-y-[100%]"></div>
